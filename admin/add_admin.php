 			                ...
 			                <div class="card-body">
 			                    <!-- <form method="POST" action="add_admin_endpoint.php"> -->
 			                        ...
 			                        <div class="form-group row">
 			                            ...
 			                            <div class="col-md-6">
 			                                <input type="text" class="form-control lname" name="lname" placeholder="Last Name" required autofocus onkeyup="this.value=this.value.replace(/[^A-Za-z]/g,'');">
 			                            </div>
 			                        </div>
 			                        <!-- Middle Name -->
 			                        <div class="form-group row">
 			                            ...
 			                            <div class="col-md-6">
 			                                <input type="text" class="form-control mname" name="mname" placeholder="Middle Name" required autofocus onkeyup="this.value=this.value.replace(/[^A-Za-z]/g,'');">
 			                        ...
 			                        <div class="form-group row">
 			                            ...
 			                            <div class="col-md-6">
 			                                <input type="tel" class="form-control phone_numer" name="phone_numer" placeholder="Phone Name" required autofocus ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" pattern='[\+]\d{2}[\(]\d{2}[\)]\d{4}[\-]\d{4}' title='Phone Number (Format: +99(99)9999-9999)'>
 			                                    <span class="invalid-feedback">
 			                                    </span>
