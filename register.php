 			                ...
 			                <div class="card-body">
 			                    <form method="POST" action="add_user_owner.php">
 			                        ...
 			                        <div class="form-group row">
 			                            ...
 			                            <div class="col-md-6">
 			                                <input id="email" type="email" class="form-control" name="email" required autofocus placeholder="Email Address" onblur="return validate_email()">
 			                        ...
 			                        <div class="form-group row">
 			                            ...
 			                            <div class="col-md-6">
 			                                <input type="tel" class="form-control phone_numer" name="phone_numer" id="phone_number" placeholder="Phone Name" required autofocus ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" pattern='^(09|\+639)\d{9}$' title='Format: 0999-999-9999 or +(639)999-999-9999' onblur="return validate_phone()">
 			                        ...
 			                        <div class="form-group row mb-0">
 			                            <div class="col-md-6 offset-md-4">
 			                                <button type="submit" name="submit" id="register_submit" disabled class="btn btn-primary">
 			                                    Register
 			                                </button>
 			                            </div>
 			                        </div>
